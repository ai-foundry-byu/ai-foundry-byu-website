...
export const TEAM: Member[] = [
  ...
  { name: "Dawson Broadbent", role: "Undergraduate", bio: "Dawson is a BYU Information Systems student starting the Master of Information Systems Management program on the AI track. He builds Workday reports, integrations, and orchestrations for BYU's finance and HR systems, and is building BidForge, a tool that uses Claude Code and vision models to automate estimating for electricians. He coauthored published research on AI for social good (AMCIS 2025).", linkedin: "https://www.linkedin.com/in/dawsonfbroadbent/", photo: "/team/dawson-broadbent.jpg" },
