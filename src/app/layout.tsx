...
export const metadata: Metadata = {
  ...
  // The anvil on navy, generated by scripts/build-icons.py. The SVG is listed
  // first because browsers that understand it prefer it and it stays sharp at
  // any size; the PNG is the fallback for those that do not. src/app/favicon.ico
